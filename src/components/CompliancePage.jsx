...
const MATRIX_ROWS = [
  ...
  },
  {
    ...
    capDesc: '7 ML anomaly detection jobs: DNS entropy, auth anomalies, rare processes, rare network destinations, new network device, and compliance metric drift.',
    modalHow: 'The compliance pack deploys 7 pre-configured ML anomaly detection jobs. Each job includes its datafeed configuration — ML jobs build behavioral baselines automatically from historical log data with no manual tuning required at deployment. Jobs cover: DNS entropy anomalies (Category K), authentication anomalies and rare IP access patterns (Category A), rare process execution on Linux and Windows hosts, rare destination countries (Category B), new or rarely-seen devices per network segment (Element 1 / Appendix A HWAM, backing Category L), and compliance metric drift detection for maturity monitoring. ML-generated anomaly records constitute Appendix B Category I events.',
